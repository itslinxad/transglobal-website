        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-5rem)] py-16 md:py-20">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-xl">
              Comprehensive freight forwarding, moving, and storage solutions
              connecting the Philippines to the world. Experience reliability,
              expertise, and exceptional service with every shipment.
            </p>
            ...
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-100">
                ...
                <div className="space-y-4">
                  {/* Service Item 1 */}
                  <div className="flex items-center p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl hover:shadow-md transition-all duration-200 group">
                  ...
                  {/* Service Item 2 */}
                  <div className="flex items-center p-4 bg-gradient-to-r from-secondary/10 to-secondary/5 rounded-xl hover:shadow-md transition-all duration-200 group">
                  ...
                  {/* Service Item 3 */}
                  <div className="flex items-center p-4 bg-gradient-to-r from-accent/10 to-accent/5 rounded-xl hover:shadow-md transition-all duration-200 group">
