          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              ...
              {contactInfo.map((info) => (
                <Card key={info.id} padding="md" className="border-l-4 border-primary">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're here to help with all your logistics and moving needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card hover padding="lg" className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Get accurate pricing for your shipping or moving project
              </p>
            </Card>
            ...
            <Card hover padding="lg" className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Consult with our logistics professionals for best solutions
              </p>
            </Card>
            ...
            <Card hover padding="lg" className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Our team is available to assist with urgent shipments
              </p>
            </Card>
            ...
            <Card hover padding="lg" className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Build long-term relationships with dedicated account managers
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-200 mb-8">
              With our headquarters in Metro Manila and a global network of partners, we provide 
              logistics services throughout the Philippines and to over 50 countries worldwide. 
              Whether you need domestic forwarding or international shipping, we're here to help.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div>
                <div className="text-3xl font-bold text-secondary mb-2">Philippines</div>
